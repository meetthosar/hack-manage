...
class FillPermissionsForHackthonsTable extends Migration
{
    ...
    /**
     * FillPermissionsForHackthonsTable constructor.
     */
    public function __construct()
    {
        ...
        $this->permissions = collect([
            'admin.hackthon',
            'admin.hackthon.index',
            'admin.hackthon.create',
            'admin.hackthon.show',
            'admin.hackthon.edit',
            'admin.hackthon.delete'
        ]);
    }
