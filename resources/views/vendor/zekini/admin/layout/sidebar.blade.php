<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
    ...
    <svg class="nav-icon">
        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
            ...
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/permission') }}">
    <svg class="nav-icon">
        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
    </svg> Permission</a>
</li>
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/role') }}">
    <svg class="nav-icon">
        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
    </svg> Role</a>
</li>
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/activitylog') }}">
    <svg class="nav-icon">
        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
    </svg> ActivityLog</a>
</li>
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/hackthon') }}">
    <svg class="nav-icon">
        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
    </svg> Hackthon</a>
</li>
